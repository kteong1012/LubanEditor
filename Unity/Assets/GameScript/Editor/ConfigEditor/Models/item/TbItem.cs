...
__SelectData.majorType = (editor.cfg.item.EMajorType)UnityEditor.EditorGUILayout.EnumPopup(__SelectData.majorType, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
__SelectData.minorType = (editor.cfg.item.EMinorType)UnityEditor.EditorGUILayout.EnumPopup(__SelectData.minorType, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
__SelectData.maxPileNum = UnityEditor.EditorGUILayout.IntField(__SelectData.maxPileNum, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
__SelectData.quality = (editor.cfg.item.EItemQuality)UnityEditor.EditorGUILayout.EnumPopup(__SelectData.quality, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
__SelectData.icon = UnityEditor.EditorGUILayout.TextField(__SelectData.icon, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
__SelectData.iconBackgroud = UnityEditor.EditorGUILayout.TextField(__SelectData.iconBackgroud, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
__SelectData.iconMask = UnityEditor.EditorGUILayout.TextField(__SelectData.iconMask, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
__SelectData.showOrder = UnityEditor.EditorGUILayout.IntField(__SelectData.showOrder, GUILayout.Width(150));
