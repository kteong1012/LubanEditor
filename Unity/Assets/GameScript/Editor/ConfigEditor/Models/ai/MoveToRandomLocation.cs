...
public sealed class MoveToRandomLocation :  ai.Task 
{
    ...
    private const string TYPE_STR = "MoveToRandomLocation";
    ...
    public static void RenderMoveToRandomLocation(MoveToRandomLocation obj)
    {
...
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("origin_position_key", "origin_position_key"), GUILayout.Width(100));
}
else
{
...
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("radius", "radius"), GUILayout.Width(100));
}
else
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("radius", ""), GUILayout.Width(100));
}
this.radius = UnityEditor.EditorGUILayout.DoubleField(this.radius, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}    }
    public static MoveToRandomLocation LoadJsonMoveToRandomLocation(SimpleJSON.JSONNode _json, Action<Luban.EditorBeanBase> setChangeAction = null)
    {
