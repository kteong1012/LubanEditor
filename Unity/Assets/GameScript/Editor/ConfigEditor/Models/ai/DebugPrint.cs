...
{
    public DebugPrint(Action<Luban.EditorBeanBase> setChangeAction = null)  : base(setChangeAction) 
    {
        _setChangeAction = setChangeAction;
            text = "";
    }
    public override string GetTypeStr() => TYPE_STR;
    private const string TYPE_STR = "DebugPrint";
    ...
    public static void RenderDebugPrint(DebugPrint obj)
    {
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    public static DebugPrint LoadJsonDebugPrint(SimpleJSON.JSONNode _json, Action<Luban.EditorBeanBase> setChangeAction = null)
    {
