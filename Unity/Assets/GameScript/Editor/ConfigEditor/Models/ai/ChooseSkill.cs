...
public sealed class ChooseSkill :  ai.Task 
{
    ...
    private const string TYPE_STR = "ai.ChooseSkill";
...
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("result_skill_id_key", "result_skill_id_key"), GUILayout.Width(100));
}
else
{
