...
namespace editor.cfg.test
{
    ...
    {
        private List<test.CompositeJsonTable2> _datas = new List<test.CompositeJsonTable2>();
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = new test.CompositeJsonTable2();
        ...
        private string GetDataJson(test.CompositeJsonTable2 data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new test.CompositeJsonTable2());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
        ...
        private string GetId(test.CompositeJsonTable2 data)
        {
            if (data == null)
            {
        ...
        private test.CompositeJsonTable2 SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
