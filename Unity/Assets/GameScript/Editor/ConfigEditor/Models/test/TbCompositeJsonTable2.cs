...
{
    public partial class TbCompositeJsonTable2 : IConfigEditorTable
    {
        private List<editor.cfg.test.CompositeJsonTable2> _datas = new List<editor.cfg.test.CompositeJsonTable2>();
        ...
        private string _name => "TbCompositeJsonTable2";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbCompositeJsonTable2(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.test.CompositeJsonTable2.LoadJsonCompositeJsonTable2(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.test.CompositeJsonTable2.LoadJsonCompositeJsonTable2(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.test.CompositeJsonTable2.SaveJsonCompositeJsonTable2(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(editor.cfg.test.CompositeJsonTable2 data)
        {
            var json = new JSONObject();
            editor.cfg.test.CompositeJsonTable2.SaveJsonCompositeJsonTable2(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.test.CompositeJsonTable2());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
renderData.y = UnityEditor.EditorGUILayout.IntField(renderData.y, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //editor.cfg.test.CompositeJsonTable2.RenderCompositeJsonTable2(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private string GetId(editor.cfg.test.CompositeJsonTable2 data)
        {
            if (data == null)
            {
        ...
        private editor.cfg.test.CompositeJsonTable2 __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
