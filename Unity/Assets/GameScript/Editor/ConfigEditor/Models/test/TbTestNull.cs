...
{
    public partial class TbTestNull : IConfigEditorTable
    {
        private List<editor.cfg.test.TestNull> _datas = new List<editor.cfg.test.TestNull>();
        ...
        private string _name => "TbTestNull";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbTestNull(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.test.TestNull.LoadJsonTestNull(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.test.TestNull.LoadJsonTestNull(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.test.TestNull.SaveJsonTestNull(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(editor.cfg.test.TestNull data)
        {
            var json = new JSONObject();
            editor.cfg.test.TestNull.SaveJsonTestNull(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.test.TestNull());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
}
{
    if (ConfigEditorSettings.showComment)
    {
        var __index1 = (int)renderData.x2;
        var __alias1 = (test.DemoEnum_Alias)renderData.x2;
        ...
        renderData.x2 = (editor.cfg.test.DemoEnum)__item1.Value;
    }
    else
    {
        renderData.x2 = (editor.cfg.test.DemoEnum)UnityEditor.EditorGUILayout.EnumPopup(renderData.x2, GUILayout.Width(150));
    }
}
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
...
renderData.x3.x1 = UnityEditor.EditorGUILayout.IntField(renderData.x3.x1, GUILayout.Width(150));
...
{
    if (renderData.x4 == null)
{   
    renderData.x4 = test.DemoDynamic.Create("DemoD2");
}
    test.DemoDynamic.RenderDemoDynamic(ref renderData.x4);
}
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //editor.cfg.test.TestNull.RenderTestNull(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private string GetId(editor.cfg.test.TestNull data)
        {
            if (data == null)
            {
        ...
        private editor.cfg.test.TestNull __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
