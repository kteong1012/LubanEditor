...
namespace editor.cfg.test
{
    ...
    {
        private List<test.DemoType2> _datas = new List<test.DemoType2>();
        ...
        private string GetDataJson(test.DemoType2 data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        private string GetId(test.DemoType2 data)
        {
            if (data == null)
            {
        ...
        private test.DemoType2 SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
