...
namespace editor.cfg.test
{
    ...
    {
        private List<test.TestBeRef> _datas = new List<test.TestBeRef>();
        ...
        private string GetDataJson(test.TestBeRef data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        private string GetId(test.TestBeRef data)
        {
            if (data == null)
            {
        ...
        private test.TestBeRef SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
