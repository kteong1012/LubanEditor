...
{
    public partial class TbTestBeRef2 : IConfigEditorTable
    {
        private List<editor.cfg.test.TestBeRef> _datas = new List<editor.cfg.test.TestBeRef>();
        ...
        private string _name => "TbTestBeRef2";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbTestBeRef2(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.test.TestBeRef.LoadJsonTestBeRef(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.test.TestBeRef.LoadJsonTestBeRef(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.test.TestBeRef.SaveJsonTestBeRef(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(editor.cfg.test.TestBeRef data)
        {
            var json = new JSONObject();
            editor.cfg.test.TestBeRef.SaveJsonTestBeRef(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.test.TestBeRef());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
renderData.count = UnityEditor.EditorGUILayout.IntField(renderData.count, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //editor.cfg.test.TestBeRef.RenderTestBeRef(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private string GetId(editor.cfg.test.TestBeRef data)
        {
            if (data == null)
            {
        ...
        private editor.cfg.test.TestBeRef __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
