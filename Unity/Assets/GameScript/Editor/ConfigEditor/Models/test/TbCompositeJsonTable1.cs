...
namespace editor.cfg.test
{
    ...
    {
        private List<test.CompositeJsonTable1> _datas = new List<test.CompositeJsonTable1>();
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = new test.CompositeJsonTable1();
        ...
        private string GetDataJson(test.CompositeJsonTable1 data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new test.CompositeJsonTable1());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
        ...
        private string GetId(test.CompositeJsonTable1 data)
        {
            if (data == null)
            {
        ...
        private test.CompositeJsonTable1 SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
