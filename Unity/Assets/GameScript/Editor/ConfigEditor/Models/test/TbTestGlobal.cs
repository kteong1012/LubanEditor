...
namespace editor.cfg.test
{
    public partial class TbTestGlobal : IConfigEditorTable
    {
        ...
        private string _name => "TbTestGlobal";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbTestGlobal(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.test.TestGlobal.LoadJsonTestGlobal(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.test.TestGlobal.LoadJsonTestGlobal(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.test.TestGlobal.SaveJsonTestGlobal(data, json);
                jsonArray.Add(json);
            }
...
renderData.unlockEquip = UnityEditor.EditorGUILayout.IntField(renderData.unlockEquip, GUILayout.Width(150));
...
renderData.unlockHero = UnityEditor.EditorGUILayout.IntField(renderData.unlockHero, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
        ...
        private editor.cfg.test.TestGlobal __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
