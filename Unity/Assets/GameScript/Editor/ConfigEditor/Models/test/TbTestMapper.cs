...
{
    public partial class TbTestMapper : IConfigEditorTable
    {
        private List<editor.cfg.test.TestMapper> _datas = new List<editor.cfg.test.TestMapper>();
        ...
        private string _name => "TbTestMapper";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbTestMapper(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.test.TestMapper.LoadJsonTestMapper(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.test.TestMapper.LoadJsonTestMapper(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.test.TestMapper.SaveJsonTestMapper(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(editor.cfg.test.TestMapper data)
        {
            var json = new JSONObject();
            editor.cfg.test.TestMapper.SaveJsonTestMapper(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.test.TestMapper());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
}
{
    if (ConfigEditorSettings.showComment)
    {
        var __index1 = (int)renderData.audioType;
        var __alias1 = (AudioType_Alias)renderData.audioType;
        ...
        renderData.audioType = (editor.cfg.AudioType)__item1.Value;
    }
    else
    {
        renderData.audioType = (editor.cfg.AudioType)UnityEditor.EditorGUILayout.EnumPopup(renderData.audioType, GUILayout.Width(150));
    }
}
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
        ...
        private string GetId(editor.cfg.test.TestMapper data)
        {
            if (data == null)
            {
        ...
        private editor.cfg.test.TestMapper __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
