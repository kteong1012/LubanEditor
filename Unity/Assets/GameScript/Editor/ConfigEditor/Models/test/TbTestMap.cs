...
namespace editor.cfg.test
{
    ...
    {
        private List<editor.cfg.test.TestMap> _datas = new List<editor.cfg.test.TestMap>();
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.test.TestMap());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
        ...
        private string GetId(editor.cfg.test.TestMap data)
        {
            if (data == null)
            {
