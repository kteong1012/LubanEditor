...
{
    public partial class TbTestMultiColumn : IConfigEditorTable
    {
        private List<editor.cfg.test.TestMultiColumn> _datas = new List<editor.cfg.test.TestMultiColumn>();
        ...
        private string _name => "TbTestMultiColumn";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbTestMultiColumn(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.test.TestMultiColumn.LoadJsonTestMultiColumn(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.test.TestMultiColumn.LoadJsonTestMultiColumn(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.test.TestMultiColumn.SaveJsonTestMultiColumn(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(editor.cfg.test.TestMultiColumn data)
        {
            var json = new JSONObject();
            editor.cfg.test.TestMultiColumn.SaveJsonTestMultiColumn(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.test.TestMultiColumn());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
renderData.a.y1 = UnityEditor.EditorGUILayout.IntField(renderData.a.y1, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
renderData.a.y2 = UnityEditor.EditorGUILayout.IntField(renderData.a.y2, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
renderData.a.y3 = UnityEditor.EditorGUILayout.IntField(renderData.a.y3, GUILayout.Width(150));
...
renderData.b.y1 = UnityEditor.EditorGUILayout.IntField(renderData.b.y1, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("y2", "y2"), GUILayout.Width(100));
...
renderData.b.y2 = UnityEditor.EditorGUILayout.IntField(renderData.b.y2, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("y3", "y3"), GUILayout.Width(100));
...
renderData.b.y3 = UnityEditor.EditorGUILayout.IntField(renderData.b.y3, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
...
renderData.c.y1 = UnityEditor.EditorGUILayout.IntField(renderData.c.y1, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("y2", "y2"), GUILayout.Width(100));
...
renderData.c.y2 = UnityEditor.EditorGUILayout.IntField(renderData.c.y2, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
    UnityEditor.EditorGUILayout.LabelField(new UnityEngine.GUIContent("y3", "y3"), GUILayout.Width(100));
...
renderData.c.y3 = UnityEditor.EditorGUILayout.IntField(renderData.c.y3, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //editor.cfg.test.TestMultiColumn.RenderTestMultiColumn(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private string GetId(editor.cfg.test.TestMultiColumn data)
        {
            if (data == null)
            {
        ...
        private editor.cfg.test.TestMultiColumn __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
