...
namespace editor.cfg.test
{
    ...
    {
        private List<test.TestMultiColumn> _datas = new List<test.TestMultiColumn>();
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = new test.TestMultiColumn();
        ...
        private string GetDataJson(test.TestMultiColumn data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new test.TestMultiColumn());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
        ...
        private string GetId(test.TestMultiColumn data)
        {
            if (data == null)
            {
        ...
        private test.TestMultiColumn SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
