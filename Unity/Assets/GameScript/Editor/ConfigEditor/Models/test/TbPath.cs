...
namespace editor.cfg.test
{
    ...
    {
        private List<test.Path> _datas = new List<test.Path>();
        ...
        private string GetDataJson(test.Path data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        private string GetId(test.Path data)
        {
            if (data == null)
            {
