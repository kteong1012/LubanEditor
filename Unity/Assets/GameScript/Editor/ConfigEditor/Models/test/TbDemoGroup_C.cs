...
namespace editor.cfg.test
{
    ...
    {
        private List<test.DemoGroup> _datas = new List<test.DemoGroup>();
        ...
        private string GetDataJson(test.DemoGroup data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        private string GetId(test.DemoGroup data)
        {
            if (data == null)
            {
        ...
        private test.DemoGroup SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
