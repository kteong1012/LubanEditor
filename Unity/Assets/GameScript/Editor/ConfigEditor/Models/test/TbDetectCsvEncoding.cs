...
{
    public partial class TbDetectCsvEncoding : IConfigEditorTable
    {
        private List<editor.cfg.test.DetectEncoding> _datas = new List<editor.cfg.test.DetectEncoding>();
        ...
        private string _name => "TbDetectCsvEncoding";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbDetectCsvEncoding(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.test.DetectEncoding.LoadJsonDetectEncoding(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.test.DetectEncoding.LoadJsonDetectEncoding(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.test.DetectEncoding.SaveJsonDetectEncoding(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(editor.cfg.test.DetectEncoding data)
        {
            var json = new JSONObject();
            editor.cfg.test.DetectEncoding.SaveJsonDetectEncoding(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.test.DetectEncoding());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //editor.cfg.test.DetectEncoding.RenderDetectEncoding(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private string GetId(editor.cfg.test.DetectEncoding data)
        {
            if (data == null)
            {
        ...
        private editor.cfg.test.DetectEncoding __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
