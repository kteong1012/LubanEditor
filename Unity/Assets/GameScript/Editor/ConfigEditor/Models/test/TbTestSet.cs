...
__SelectData.x0 = UnityEditor.EditorGUILayout.TextField(__SelectData.x0, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
}
{
    ...
    if (GUILayout.Button("import", GUILayout.Width(100)))
    {
        ConfigEditorImportWindow.Open((__importJsonText1) => 
        {
            ...
            __SelectData.x1.Add(__importElement1);
        });
    }
    UnityEditor.EditorGUILayout.EndHorizontal();
...
}
{
    ...
    for (int __i1 = 0; __i1 < __n1; __i1++)
    {
        ...
        UnityEditor.EditorGUILayout.LabelField(__i1.ToString(), GUILayout.Width(20));
        long __e1 = __SelectData.x2[__i1];
...
}
{
    ...
    for (int __i1 = 0; __i1 < __n1; __i1++)
    {
        ...
        UnityEditor.EditorGUILayout.LabelField(__i1.ToString(), GUILayout.Width(20));
        string __e1 = __SelectData.x3[__i1];
    ...
    if (GUILayout.Button("import", GUILayout.Width(100)))
    {
        ConfigEditorImportWindow.Open((__importJsonText1) => 
        {
            ...
            __SelectData.x3.Add(__importElement1);
        });
    }
    UnityEditor.EditorGUILayout.EndHorizontal();
    UnityEditor.EditorGUILayout.EndVertical();
...
}
{
    ...
    for (int __i1 = 0; __i1 < __n1; __i1++)
    {
        ...
        UnityEditor.EditorGUILayout.LabelField(__i1.ToString(), GUILayout.Width(20));
        editor.cfg.test.DemoEnum __e1 = __SelectData.x4[__i1];
...
__e1 = (editor.cfg.test.DemoEnum)UnityEditor.EditorGUILayout.EnumPopup(__e1, GUILayout.Width(150));;
    ...
    if (GUILayout.Button("+", GUILayout.Width(20)))
    {
        __SelectData.x4.Add(editor.cfg.test.DemoEnum.NONE);
    }
    if (GUILayout.Button("import", GUILayout.Width(100)))
    {
        ConfigEditorImportWindow.Open((__importJsonText1) => 
        {
            ...
            __SelectData.x4.Add(__importElement1);
        });
    }
    UnityEditor.EditorGUILayout.EndHorizontal();
    UnityEditor.EditorGUILayout.EndVertical();
