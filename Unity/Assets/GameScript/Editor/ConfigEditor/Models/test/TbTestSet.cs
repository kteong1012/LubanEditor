...
namespace editor.cfg.test
{
    ...
    {
        private List<test.TestSet> _datas = new List<test.TestSet>();
        ...
        private string GetDataJson(test.TestSet data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        private string GetId(test.TestSet data)
        {
            if (data == null)
            {
        ...
        private test.TestSet SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
