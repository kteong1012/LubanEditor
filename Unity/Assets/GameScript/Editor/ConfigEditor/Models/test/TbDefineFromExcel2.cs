...
namespace editor.cfg.test
{
    ...
    {
        private List<test.DefineFromExcel2> _datas = new List<test.DefineFromExcel2>();
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = new test.DefineFromExcel2();
        ...
        private string GetDataJson(test.DefineFromExcel2 data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new test.DefineFromExcel2());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
        ...
        private string GetId(test.DefineFromExcel2 data)
        {
            if (data == null)
            {
        ...
        private test.DefineFromExcel2 SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
