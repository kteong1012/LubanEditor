...
namespace editor.cfg.test
{
    ...
    {
        private List<test.ExcelFromJsonMultiRow> _datas = new List<test.ExcelFromJsonMultiRow>();
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = new test.ExcelFromJsonMultiRow();
        ...
        private string GetDataJson(test.ExcelFromJsonMultiRow data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new test.ExcelFromJsonMultiRow());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
        ...
        private string GetId(test.ExcelFromJsonMultiRow data)
        {
            if (data == null)
            {
        ...
        private test.ExcelFromJsonMultiRow SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
