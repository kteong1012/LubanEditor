...
{
    public partial class TbExcelFromJsonMultiRow : IConfigEditorTable
    {
        private List<editor.cfg.test.ExcelFromJsonMultiRow> _datas = new List<editor.cfg.test.ExcelFromJsonMultiRow>();
        ...
        private string _name => "TbExcelFromJsonMultiRow";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbExcelFromJsonMultiRow(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.test.ExcelFromJsonMultiRow.LoadJsonExcelFromJsonMultiRow(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.test.ExcelFromJsonMultiRow.LoadJsonExcelFromJsonMultiRow(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.test.ExcelFromJsonMultiRow.SaveJsonExcelFromJsonMultiRow(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(editor.cfg.test.ExcelFromJsonMultiRow data)
        {
            var json = new JSONObject();
            editor.cfg.test.ExcelFromJsonMultiRow.SaveJsonExcelFromJsonMultiRow(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.test.ExcelFromJsonMultiRow());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
renderData.x = UnityEditor.EditorGUILayout.IntField(renderData.x, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
}
{
    ...
    int __n1 = renderData.items.Count;
    ...
    for (int __i1 = 0; __i1 < __n1; __i1++)
    {
        ...
        if (GUILayout.Button("-", GUILayout.Width(20)))
        {
            renderData.items.RemoveAt(__i1);
            UnityEditor.EditorGUILayout.EndHorizontal();
            break;
        }
        UnityEditor.EditorGUILayout.LabelField(__i1.ToString(), GUILayout.Width(20));
        editor.cfg.test.TestRow __e1 = renderData.items[__i1];
        {
    UnityEditor.EditorGUILayout.BeginVertical(_areaStyle);UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
if (GUILayout.Button("…", GUILayout.Width(20)))
{
    TextInputWindow.GetTextAsync(__e1.z,__x =>__e1.z = __x);
}
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
    ...
    if (ConfigEditorSettings.showImportButton && GUILayout.Button("import", GUILayout.Width(100)))
    {
        ConfigEditorImportWindow.Open((__importJsonText1) => 
        {
            ...
            renderData.items.Add(__importElement1);
        });
    }
    UnityEditor.EditorGUILayout.EndHorizontal();
    UnityEditor.EditorGUILayout.EndVertical();
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //editor.cfg.test.ExcelFromJsonMultiRow.RenderExcelFromJsonMultiRow(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private string GetId(editor.cfg.test.ExcelFromJsonMultiRow data)
        {
            if (data == null)
            {
        ...
        private editor.cfg.test.ExcelFromJsonMultiRow __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
