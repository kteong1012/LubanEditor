...
{
    public partial class TbMultiUnionIndexList : IConfigEditorTable
    {
        private List<editor.cfg.test.MultiUnionIndexList> _datas = new List<editor.cfg.test.MultiUnionIndexList>();
        ...
        private string _name => "TbMultiUnionIndexList";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbMultiUnionIndexList(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.test.MultiUnionIndexList.LoadJsonMultiUnionIndexList(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.test.MultiUnionIndexList.LoadJsonMultiUnionIndexList(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.test.MultiUnionIndexList.SaveJsonMultiUnionIndexList(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(editor.cfg.test.MultiUnionIndexList data)
        {
            var json = new JSONObject();
            editor.cfg.test.MultiUnionIndexList.SaveJsonMultiUnionIndexList(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.test.MultiUnionIndexList());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
__SelectData.id1 = UnityEditor.EditorGUILayout.IntField(__SelectData.id1, GUILayout.Width(150));
...
__SelectData.id2 = UnityEditor.EditorGUILayout.LongField(__SelectData.id2, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
__SelectData.id3 = UnityEditor.EditorGUILayout.TextField(__SelectData.id3, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
        ...
        private string GetId(editor.cfg.test.MultiUnionIndexList data)
        {
            if (data == null)
            {
            ...
            return GetUnionKey(data.id1, data.id2, data.id3);
        }
        ...
        private editor.cfg.test.MultiUnionIndexList __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
