...
namespace editor.cfg.test
{
    ...
    {
        private List<test.MultiRowTitle> _datas = new List<test.MultiRowTitle>();
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = new test.MultiRowTitle();
        ...
        private string GetDataJson(test.MultiRowTitle data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new test.MultiRowTitle());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
        ...
        private string GetId(test.MultiRowTitle data)
        {
            if (data == null)
            {
        ...
        private test.MultiRowTitle SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
