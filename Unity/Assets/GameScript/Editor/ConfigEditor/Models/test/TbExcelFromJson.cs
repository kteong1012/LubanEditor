...
namespace editor.cfg.test
{
    ...
    {
        private List<test.ExcelFromJson> _datas = new List<test.ExcelFromJson>();
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = new test.ExcelFromJson();
        ...
        private string GetDataJson(test.ExcelFromJson data)
        {
            var json = new JSONObject();
            data?.SaveJson(json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new test.ExcelFromJson());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
        ...
        private string GetId(test.ExcelFromJson data)
        {
            if (data == null)
            {
        ...
        private test.ExcelFromJson SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
