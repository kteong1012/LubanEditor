...
namespace editor.cfg.l10n
{
    public partial class TbL10NDemo : IConfigEditorTable
    {
        ...
        private string _name => "TbL10NDemo";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbL10NDemo(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.l10n.L10NDemo.LoadJsonL10NDemo(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.l10n.L10NDemo.LoadJsonL10NDemo(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.l10n.L10NDemo.SaveJsonL10NDemo(data, json);
                jsonArray.Add(json);
            }
...
__SelectData.text = UnityEditor.EditorGUILayout.TextField(__SelectData.text, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
        ...
        private editor.cfg.l10n.L10NDemo __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
