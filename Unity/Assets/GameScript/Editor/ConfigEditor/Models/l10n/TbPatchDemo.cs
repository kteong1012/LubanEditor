...
{
    public partial class TbPatchDemo : IConfigEditorTable
    {
        private List<editor.cfg.l10n.PatchDemo> _datas = new List<editor.cfg.l10n.PatchDemo>();
        ...
        private string _name => "TbPatchDemo";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbPatchDemo(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.l10n.PatchDemo.LoadJsonPatchDemo(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.l10n.PatchDemo.LoadJsonPatchDemo(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.l10n.PatchDemo.SaveJsonPatchDemo(data, json);
                jsonArray.Add(json);
            }
            return jsonArray.ToString(4);
        }

        private string GetDataJson(editor.cfg.l10n.PatchDemo data)
        {
            var json = new JSONObject();
            editor.cfg.l10n.PatchDemo.SaveJsonPatchDemo(data, json);
        ...
        public void OnGUI()
        {
            ...
            {
                _datas.Add(new editor.cfg.l10n.PatchDemo());
            }
            if (GUILayout.Button("-", GUILayout.Width(20)))
            {
...
renderData.value = UnityEditor.EditorGUILayout.IntField(renderData.value, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //editor.cfg.l10n.PatchDemo.RenderPatchDemo(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private string GetId(editor.cfg.l10n.PatchDemo data)
        {
            if (data == null)
            {
        ...
        private editor.cfg.l10n.PatchDemo __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
