...
namespace editor.cfg.common
{
    public partial class TbGlobalConfig : IConfigEditorTable
    {
        ...
        private string _name => "TbGlobalConfig";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbGlobalConfig(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.common.GlobalConfig.LoadJsonGlobalConfig(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.common.GlobalConfig.LoadJsonGlobalConfig(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.common.GlobalConfig.SaveJsonGlobalConfig(data, json);
                jsonArray.Add(json);
            }
...
renderData.x5 = UnityEditor.EditorGUILayout.IntField(renderData.x5, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
renderData.x6 = UnityEditor.EditorGUILayout.IntField(renderData.x6, GUILayout.Width(150));
UnityEditor.EditorGUILayout.EndHorizontal();UnityEditor.EditorGUILayout.BeginHorizontal();
if (ConfigEditorSettings.showComment)
{
...
}
{
    ...
    if (ConfigEditorSettings.showImportButton && GUILayout.Button("import", GUILayout.Width(100)))
    {
        ConfigEditorImportWindow.Open((__importJsonText1) => 
        {
            ...
            renderData.x7.Add(__importElement1);
        });
    }
    UnityEditor.EditorGUILayout.EndHorizontal();
...
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //editor.cfg.common.GlobalConfig.RenderGlobalConfig(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private editor.cfg.common.GlobalConfig __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
