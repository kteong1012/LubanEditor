...
namespace editor.cfg.tag
{
    public partial class TbTestTag : IConfigEditorTable
    {
        ...
        private string _name => "TbTestTag";
        private GUIStyle _areaStyle = new GUIStyle(GUI.skin.button);


        public TbTestTag(string dataFilePath)
        {
        ...
        public void Load()
        {
            ...
            if (File.Exists(_dataFilePath))
            {
                ...
                if (json.IsArray)
                {
                    ...
                    {
                        var data = editor.cfg.tag.TestTag.LoadJsonTestTag(node.Value);
                        _datas.Add(data);
                ...
                {
                    var data = editor.cfg.tag.TestTag.LoadJsonTestTag(json);
                    _datas.Add(data);
        ...
        private string GetTableJson()
        {
            ...
            foreach (var data in _datas)
            {
                ...
                editor.cfg.tag.TestTag.SaveJsonTestTag(data, json);
                jsonArray.Add(json);
            }
...
renderData.value = UnityEditor.EditorGUILayout.TextField(renderData.value, GUILayout.Width(150));
if (GUILayout.Button("…", GUILayout.Width(20)))
{
    TextInputWindow.GetTextAsync(renderData.value,__x =>renderData.value = __x);
}
UnityEditor.EditorGUILayout.EndHorizontal();    UnityEditor.EditorGUILayout.EndVertical();
}                //editor.cfg.tag.TestTag.RenderTestTag(__SelectData);
            }
            GUILayout.EndScrollView();
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        private editor.cfg.tag.TestTag __SelectData
        {
            get
            {
                if (_selectIndex >= 0 && _selectIndex < _datas.Count)
